...
Mirrors report.py exactly, reading the separate stock logs/portfolio.
"""
...
TRADE_LOG = LOG_FOLDER / "stock_atlas_log.csv"

EQUITY_LOG = LOG_FOLDER / "stock_equity_log.csv"
...
def print_report():
    ...
    print()
    print("=" * 70)
    print("              ATLAS AI - STOCK PERFORMANCE REPORT")
    print("=" * 70)
    ...
    if closed:
        ...
        for trade in closed:
            reason_counts[trade["reason"]] = (
                reason_counts.get(trade["reason"], 0) + 1
            )
